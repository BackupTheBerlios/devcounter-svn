	...
	<ul>
    	<li>I am now going to try to create a DB_<?php echo $sys_name;?> database connection. If this line is the last thing that you see then you should look at these points and fix them before proceeding:
		<ul>
