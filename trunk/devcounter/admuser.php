...
#
# $Id: admuser.php,v 1.2 2002/08/26 10:15:04 helix Exp $
#
######################################################################
...
<?php
  echo "  <td align=\"right\" bgcolor=\"$th_box_body_bgcolor\"><input type=\"submit\" name=\"create\" value=\"".$t->translate("Create User")."\"></td>\n";
?>
</tr>
</form>
<?php
